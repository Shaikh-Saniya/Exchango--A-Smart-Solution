...
import com.example.exchango.activity.Authentication.EmailLogIn
import com.example.exchango.activity.Authentication.EmailSignUp
...
class WelcomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        welcome.signUp.setOnClickListener {
            ...
            val intent = Intent(this@WelcomeActivity, EmailSignUp::class.java)
            startActivity(intent)
        }
        welcome.signIn.setOnClickListener {
            Log.d("check","joinUsButton clicked")
            val intent = Intent(this@WelcomeActivity, EmailLogIn::class.java)
            startActivity(intent)
        }
    }
}
